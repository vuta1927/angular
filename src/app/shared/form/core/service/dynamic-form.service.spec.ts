...
describe('DynamicFormService test suite', () => {
    ...
    it('should find a dynamic form control model by id', () => {
        ...
        expect(service.findById('testCheckbox', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testCheckboxGroup', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testDatepicker', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testFormArray', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testInput', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testRadioGroup', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testSelect', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testSlider', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testSwitch', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testTextArea', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testFileUpload', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testEditor', testModel) instanceof DynamicEditorModel)
            .toBe(true);
        expect(service.findById('testTimePicker', testModel) instanceof DynamicTimePickerModel)
            .toBe(true);
        expect(service.findById('testRating', testModel) instanceof DynamicRatingModel)
            .toBe(true);
    });

    it('should find a nested dynamic form control model by id', () => {

        expect(service.findById('testCheckboxGroup1', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('testCheckboxGroup2', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
        expect(service.findById('nestedTestInput', testModel) instanceof DynamicFormControlModel)
            .toBe(true);
    });
    ...
    it('should resolve array group path', () => {
        ...
        expect(service.getPath(nestedModel))
            .toEqual(['testFormArray', '0', 'testNestedFormArray', '0']);
    });
    ...
    it('should add a form control to an existing form group', () => {
        ...
        expect(nestedFormGroupModel.get(nestedFormGroupModel.group.length - 1) === newModel2)
            .toBe(true);
    });
    ...
    it('should insert a form control to an existing form group', () => {
        ...
        expect(service.getPath(nestedFormGroupModel.get(0)))
            .toEqual(['testFormGroup', 'newInput2']);
    });
    ...
    it('should move up a form array group', () => {
        ...
        (formArray.at(index + step) as FormGroup).controls['testFormArrayGroupInput']
            .setValue('next test value 2');

        (model.get(index).get(0) as DynamicFormValueControlModel<DynamicFormControlValue>)
            .valueUpdates.next('next test value 1');
        (model.get(index + step).get(0) as DynamicFormValueControlModel<DynamicFormControlValue>)
            .valueUpdates.next('next test value 2');
        ...
        expect(
            (formArray.at(index) as FormGroup).controls['testFormArrayGroupInput'].value)
                .toEqual('next test value 2');
        expect(
            (formArray.at(index + step) as FormGroup).controls['testFormArrayGroupInput'].value)
                .toEqual('next test value 1');

        expect(
            (model.get(index).get(0) as DynamicFormValueControlModel<DynamicFormControlValue>)
            .value).toEqual('next test value 2');
        expect(
            (model
                .get(index + step).get(0) as DynamicFormValueControlModel<DynamicFormControlValue>)
            .value).toEqual('next test value 1');
    });
    ...
    it('should move down a form array group', () => {
        ...
        (formArray.at(index) as FormGroup)
            .controls['testFormArrayGroupInput'].setValue('next test value 1');
        (formArray.at(index + step) as FormGroup)
            .controls['testFormArrayGroupInput'].setValue('next test value 2');
        ...
        expect((formArray.at(index) as FormGroup)
            .controls['testFormArrayGroupInput'].value).toEqual('next test value 2');
        expect((formArray.at(index + step) as FormGroup)
            .controls['testFormArrayGroupInput'].value).toEqual('next test value 1');

        expect((
            model
                .get(index)
                .get(0) as DynamicFormValueControlModel<DynamicFormControlValue>).value)
                    .toEqual('next test value 2');
        expect(
            (model
                .get(index + step)
