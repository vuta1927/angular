...
export const AUTOFILL_TOKENS_CONTACT = [
    AUTOFILL_TOKEN_FAX,
    AUTOFILL_TOKEN_HOME, AUTOFILL_TOKEN_MOBILE, AUTOFILL_TOKEN_PAGER, AUTOFILL_TOKEN_WORK
];
...
export const AUTOFILL_FIELDS = [
    ...
    AUTOFILL_FIELD_HONORIFIC_SUFFIX, AUTOFILL_FIELD_NICKNAME, AUTOFILL_FIELD_USERNAME,
    AUTOFILL_FIELD_NEW_PASSWORD, AUTOFILL_FIELD_CURRENT_PASSWORD, AUTOFILL_FIELD_ORGANIZATION_TITLE,
    AUTOFILL_FIELD_ORGANIZATION,
    AUTOFILL_FIELD_COUNTRY, AUTOFILL_FIELD_COUNTRY_NAME, AUTOFILL_FIELD_POSTAL_CODE,
    AUTOFILL_FIELD_CC_NAME, AUTOFILL_FIELD_CC_GIVEN_NAME, AUTOFILL_FIELD_CC_ADDITIONAL_NAME,
    AUTOFILL_FIELD_CC_FAMILY_NAME,
    AUTOFILL_FIELD_CC_NUMBER, AUTOFILL_FIELD_CC_EXP, AUTOFILL_FIELD_CC_EXP_MONTH,
    AUTOFILL_FIELD_CC_EXP_YEAR,
    AUTOFILL_FIELD_CC_CSC, AUTOFILL_FIELD_CC_TYPE, AUTOFILL_FIELD_TRANSACTION_CURRENCY,
    AUTOFILL_FIELD_TRANSACTION_AMOUNT,
    AUTOFILL_FIELD_LANGUAGE, AUTOFILL_FIELD_BDAY, AUTOFILL_FIELD_BDAY_DAY,
    AUTOFILL_FIELD_BDAY_MONTH,
    AUTOFILL_FIELD_BDAY_YEAR, AUTOFILL_FIELD_SEX, AUTOFILL_FIELD_URL, AUTOFILL_FIELD_PHOTO
];
...
export const AUTOFILL_FIELDS_CONTACT = [
    ...
    AUTOFILL_FIELD_TEL,
    AUTOFILL_FIELD_TEL_COUNTRY_CODE, AUTOFILL_FIELD_TEL_NATIONAL, AUTOFILL_FIELD_TEL_AREA_CODE,
...
export class AutoFillUtils {
    ...
    public static isAddressToken(token: string): boolean {
        return AUTOFILL_TOKENS_ADDRESS.indexOf(token) > -1;
    }

    public static isContactField(token: string): boolean {
        return AUTOFILL_FIELDS_CONTACT.indexOf(token) > -1;
    }

    public static isContactToken(token: string): boolean {
        return AUTOFILL_TOKENS_CONTACT.indexOf(token) > -1;
    }

    public static isField(token: string): boolean {
        return AUTOFILL_FIELDS.indexOf(token) > -1;
    }

    public static isSectionToken(token: string): boolean {
        return token.startsWith('section-');
    }

    public static validate(tokens: string): boolean {
