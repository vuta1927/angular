...
describe('DynamicInputModel test suite', () => {
    ...
    it('tests if correct default type property is set', () => {
        ...
        expect(model.type).toEqual(DynamicFormControlModelType.INPUT);
    });

    it('tests if correct default input type property is set', () => {

        expect(model.inputType).toEqual('text');
    });
    ...
    it('should serialize correctly', () => {
        ...
        expect(json.type).toEqual(DynamicFormControlModelType.INPUT);
    });
});
