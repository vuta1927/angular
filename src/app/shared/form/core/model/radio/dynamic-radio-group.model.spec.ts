...
describe('DynamicRadioModel test suite', () => {
    ...
    it('should initialize correctly', () => {
        ...
        expect(model.type).toEqual(DynamicFormControlModelType.RADIO_GROUP);
    ...
    it('should make options Observable deliver ' +
        'an empty array when options are set to non-expected value', async(() => {
    ...
    it('should serialize correctly', () => {
        ...
        expect(json.type).toEqual(DynamicFormControlModelType.RADIO_GROUP);
    });
});
